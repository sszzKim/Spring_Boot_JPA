...
public class ReplyEntity {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "REPLY_SEQ" ) //DBMS 회사마자 전략이 다름
	...
	@Column(name="replywriter", length=200, nullable=false)
	private String replywriter;
	
	@Column(name="replycontent", length=200, nullable=false)
	private String replycontent;
	
	@Column(name="replyregdate", length=200, nullable=false)
